...
const Newsletter = () => {
  return (
    <section className="pt-3 bg-color  mb-5">
      <div className="container relative z-20 h-full bg-white shadow-lg">
        <section className="py-5 border custom-border-container border-gray-bord border-l-cyan-600">
          <section className="container grid-cols-2 lg:grid">
            <div className="">
              <h2 className="mb-1 text-lg font-semibold">Ивда Гео бюлетин</h2>
              <p className="mb-3 text-sm text-dark-400 lg:max-w-lg">
                Абонирайте се за нашият онлайн бюлетин, за да получавате оферти
                от нашият онлайн магазин всеки месец!
              </p>
            </div>
              ...
              <form action="" className="lg:w-10/12">
                <div className="flex flex-col items-center justify-center md:flex-row">
                  ...
                  <div className="text-sm md:mt-1 custom-border-input">
                    <button
                      type="submit"
                      className={`w-full py-2 font-medium text-white uppercase transition-colors duration-100 border px-14 bg-blue-400   border-blue-400 flex items-center justify-center  lg:hover:bg-primary-lighter lg:hover:text-white`}
                    >
                      Изпрати
                    </button>
                  </div>
